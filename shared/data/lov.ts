...
export const LOV_SEED: LovSeedRow[] = [
  ...
  { type: "DISCIPLINE", code: "ADMINISTRATIVE_LAW", value: "Direito Administrativo", sortOrder: 1 },
  { type: "DISCIPLINE", code: "ENVIRONMENTAL_LAW", value: "Direito Ambiental", sortOrder: 2 },
  { type: "DISCIPLINE", code: "CIVIL_LAW", value: "Direito Civil", sortOrder: 3 },
  { type: "DISCIPLINE", code: "CONSTITUTIONAL_LAW", value: "Direito Constitucional", sortOrder: 4 },
  { type: "DISCIPLINE", code: "CONSUMER_LAW", value: "Direito do Consumidor", sortOrder: 5 },
  { type: "DISCIPLINE", code: "LABOR_LAW", value: "Direito do Trabalho", sortOrder: 6 },
  { type: "DISCIPLINE", code: "ELECTORAL_LAW", value: "Direito Eleitoral", sortOrder: 7 },
  { type: "DISCIPLINE", code: "COMMERCIAL_LAW", value: "Direito Empresarial", sortOrder: 8 },
  { type: "DISCIPLINE", code: "FINANCIAL_LAW", value: "Direito Financeiro", sortOrder: 9 },
  { type: "DISCIPLINE", code: "INTERNATIONAL_LAW", value: "Direito Internacional", sortOrder: 10 },
  { type: "DISCIPLINE", code: "CRIMINAL_LAW", value: "Direito Penal", sortOrder: 11 },
  {
    type: "DISCIPLINE",
  ...
  { type: "DISCIPLINE", code: "TAX_LAW", value: "Direito Tributário", sortOrder: 13 },
  { type: "DISCIPLINE", code: "HUMAN_RIGHTS", value: "Direitos Humanos", sortOrder: 14 },
  {
    type: "DISCIPLINE",
  ...
  { type: "DISCIPLINE", code: "LEGAL_ETHICS", value: "Ética Profissional", sortOrder: 16 },
  { type: "DISCIPLINE", code: "LEGAL_PHILOSOPHY", value: "Filosofia do Direito", sortOrder: 17 },
  { type: "DISCIPLINE", code: "CIVIL_PROCEDURE", value: "Processo Civil", sortOrder: 18 },
  { type: "DISCIPLINE", code: "LABOR_PROCEDURE", value: "Processo do Trabalho", sortOrder: 19 },
  { type: "DISCIPLINE", code: "CRIMINAL_PROCEDURE", value: "Processo Penal", sortOrder: 20 },
