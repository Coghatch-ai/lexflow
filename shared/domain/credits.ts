...
// gpt-5.4-mini (tutor ~0.23¢, coach ~0.29¢, grade ~0.33¢ — cost model on
// issue #48): near-equal real cost, so near-equal credit cost. The BRL price
// per credit is a pack-pricing decision made at purchase-flow time (aggressive
// pricing, thin margin — owner directive), NOT hardcoded here.
